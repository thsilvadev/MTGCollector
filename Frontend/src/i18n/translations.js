const translations = {
  en: {
    ...
    'search.orderName':      'Name',
    'search.orderCmc':       'Mana Value',
    'search.orderPower':     'Power',
    'search.orderToughness': 'Toughness',
    'search.orderUsd':       'Price (USD)',
  ...
  pt: {
    ...
    'search.orderName':      'Nome',
    'search.orderCmc':       'Valor de Mana',
    'search.orderPower':     'Força',
    'search.orderToughness': 'Resistência',
    'search.orderUsd':       'Preço (USD)',
