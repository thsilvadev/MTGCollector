...
const AboutUs = () => {
    return (
        <div className={styles.container}>
            ...
            <p>Unfortunately at that time I had to choose between eating, going to the near LAN House and buying cards. So I pretty much stopped playing MTG (and eating) until recently I bought 467 cards, almost randomly. With that amount, how many decks are possible? Soon I realized, though, I had just a few good cards I wish to use in more than one deck. But interchanging 'em like that would get a bit confused, I'd had to take notes and... why not make a digital collectior? That's just it! </p>
