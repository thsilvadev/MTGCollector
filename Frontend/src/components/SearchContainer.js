      ...
      <div className={styles.SearchContainer}>
        ...
        <div class="row justify-content-evenly">
          <div class="col-sm-12 col-md-4 col-lg-1">
            ...
            <select class={selectedType + "form-select"} onChange={handleTypeChange} aria-label="Default select example">
          ...
          <div class="col-sm-12 col-md-4 col-lg-1">
            ...
            <select class={selectedSet + "form-select"} onChange={handleSetChange} aria-label="Default select example">
              <option selected> </option>
          ...
          <div className="col-sm-12 col-md-4 col-lg-1">
            ...
            <select class={selectedRarity + "form-select"} onChange={handleRarityChange} aria-label="Default select example">
              <option selected> </option>
          ...
          <div className="col-sm-12 col-md-4 col-lg-1">
            ...
            <select class={selectedColor + "form-select"} onChange={handleColorChange} aria-label="Default select example">
              <option selected> </option>
        ...
        <div class="col mt-4">
          <form role="search row">
            <input
              class={selectedName + "form-control me-2 col"} onChange={handleNameChange}
              type="search"
